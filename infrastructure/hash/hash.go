...
func (h *Service) Decode(encryptedText string) (string, error) {
	...
	key := []byte("this32characterlongkeyforAES256!") // Same key used for encryption
	...
	if len(ciphertext) < aes.BlockSize {
		log.Printf("Ciphertext too short to extract IV")
		return "", errors.New("ciphertext too short to extract IV")
	}
